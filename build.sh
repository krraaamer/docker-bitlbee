...
libgcrypt20-dev libmarkdown2-dev libpurple-dev libsqlite3-dev libwebp-dev libtool-bin git
...
libtasn1-6-dev libtool libtool-bin m4 make nettle-dev patch xz-utils git
apt clean
